    ...
    >
      ...
      >
        <div className="primitive-card-bar flex items-center justify-between gap-3 border-b border-line">
          <div className="min-w-0">
            ...
            <p
              ...
              title={`npx shadcn add ./${entry.id}.json`}
            >
              <span className="text-ink-2">$</span> npx shadcn add ./{entry.id}.json
            </p>
          </div>
        ...
        <div className="flex items-center gap-2 border-t border-line px-4 py-2.5 text-[12px] text-ink-3">
          ...
          <a
            href="https://github.com/slev12397/atrium-ui/blob/main/app/globals.css"
            target="_blank"
            rel="noreferrer"
