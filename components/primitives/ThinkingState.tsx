...
> = {
  Steps: {
    ...
    rows: [
      { primary: "Reading patient charts" },
      { primary: "Scanning lab results" },
      { primary: "Comparing vitals trends", secondary: "7 patients" },
      { primary: "Writing the rounds summary" },
    ],
  },
  Reasoning: {
    active: "Thinking",
    ...
    rows: [
      { primary: "Bed 5A culture results are pending — attending wants an update by noon." },
      { primary: "I should check medication schedules before recommending discharges." },
    ],
  },
  Search: {
    active: "Searching the web",
    done: "Searched the web",
    query: "cardiology research papers 2026",
    rows: [
      { primary: "NEJM", secondary: "nejm.org", href: "https://www.nejm.org/" },
      { primary: "JACC", secondary: "jacc.org", href: "https://www.jacc.org/" },
      { primary: "The Lancet Cardiology", secondary: "thelancet.com", href: "https://www.thelancet.com/journals/lanca" },
    ],
  },
  Coding: {
    ...
    rows: [
      { primary: "Read", secondary: "patient-records.ts", mono: true },
      { primary: "Edit", secondary: "TreatmentPlan.tsx", mono: true, add: 74, del: 41 },
