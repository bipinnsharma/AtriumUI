...
const ROWS: ToolStep[] = [
  {
    icon: "think", label: "Thinking", chip: "Planning the treatment protocol…", mono: false, detailMono: false,
    detail: [
      { text: "Patient has Type 2 Diabetes with comorbid hypertension." },
      { text: "Current guidelines recommend Metformin as first-line therapy." },
    ],
  },
  {
    icon: "write", label: "Write 204 lines", chip: "TreatmentPlan.tsx", mono: true, detailMono: true,
    detail: [
      { text: "+ const dosage = calculateDosage(weight, eGFR)", tone: "add" },
      { text: "+ return plan(patient, { firstLine: \"Metformin\" })", tone: "add" },
    ],
  },
  {
    icon: "run", label: "Rebuild and verify", chip: "npm run verify", mono: true, detailMono: true,
    detail: [
      { text: "✓ built in 1.2s" },
  ...
  {
    icon: "read", label: "Read image", chip: "vitals-chart.png", mono: true, detailMono: false,
    detail: [
      { text: "1280 × 720 · line chart, 7-day trend." },
      { text: "Blood glucose trending down 12% this week." },
    ],
  },
];

const DIFFS: ToolDiff[] = [
  { file: "medications.css", add: 13, del: 0 },
  { file: "TreatmentPlan.tsx", add: 74, del: 41 },
  { file: "guidelines.ts", add: 8, del: 2 },
];

/* hovering a file chip opens its diff — green added, red removed */
const DIFF_LINES: Record<string, ToolDiffLine[]> = {
  "medications.css": [
    { text: ".patient-card {", tone: "ctx" },
  ...
  "guidelines.ts": [
    { text: "export const firstLine = \"insulin\";", tone: "del" },
    { text: "export const firstLine = \"Metformin\";", tone: "add" },
  ],
};
