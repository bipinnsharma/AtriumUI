...
const TASK_ROWS: TaskRow[] = [
  {
    ...
    status: "done",
    details: [
      { label: "Bed 3B vitals normal", meta: "3/3" },
      { label: "Pending cultures", meta: "1" },
    ],
  },
  {
    key: "index",
    label: "Sign off on discharges",
    amount: "2 patients",
    status: "running",
    step: 2,
    details: [
      { label: "Reviewing discharge summaries", meta: "2 files" },
      { label: "Medication reconciliation", meta: "68%" },
    ],
  },
  {
    key: "draft",
    label: "Update medication lists",
    amount: "4 patients",
    status: "sequence",
    step: 3,
    details: [
      { label: "Bed 5A antibiotic调整", meta: "draft" },
      { label: "Bed 3B insulin dosage", meta: "draft" },
    ],
  },
];
