...
const MESSAGES: ChatMessage[] = [
  {
    ...
    sub: "Patient Data",
    time: "4s",
    body: "Pulled 3 months of blood glucose readings for comparison.",
  },
  {
    label: "Comparison",
    sub: "Trend Detection",
    time: "2s",
    body: "Blood glucose trending down 12% with stronger morning peaks.",
  },
];

const SUGGESTIONS = ["Patients", "Research"];
...
const DEFAULT_LABELS: ChatComposerLabels = {
  initialPrompt: "Compare blood glucose trends this month",
  placeholder: "Prompt or tag a patient with @",
};
