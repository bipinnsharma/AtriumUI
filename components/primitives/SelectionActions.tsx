...
const LEAD = "Patient presented with chest pain, ECG shows ST-elevation in leads II, III, aVF. ";
const PICKED =
  "Troponin elevated at 0.42 ng/mL, requires immediate cardiology consultation.";
const REWRITE =
  "Troponin elevated at 0.42 ng/mL with ST-elevation in inferior leads — cardiology consult initiated, aspirin administered, and telemetry activated.";
