...
const CHUNKS: ContextChunk[] = [
  {
    ...
    body: "Blood glucose monitoring must be verified before adjusting insulin dosage for diabetic patients.",
    source: "Diabetes Management Protocol.pdf",
    badge: "PDF",
    tone: "bg-red",
  },
  {
    title: "Lab results row",
    chars: "1,250 characters",
    body: "Patient vitals summary: temperature normalized, WBC count trending down, culture results pending for Bed 5A.",
    source: "Lab Results Export.csv",
    badge: "CSV",
    tone: "bg-green",
  },
];
