...
const QUESTIONS: ApprovalQuestion[] = [
  {
    q: "Which specialty should I focus on?",
    type: "radio",
    options: ["Cardiology", "Neurology", "Internal Medicine"],
  },
  {
    q: "What should I prioritize?",
    type: "check",
    options: ["Follow-ups", "New admissions", "Discharge planning"],
  },
  {
    q: "What's the urgency level?",
    type: "radio",
