...
const DEFAULT_LABELS: RecommendationLabels = {
  title: "Want me to prioritize these by urgency?",
...
const OPTIONS: RecommendationOption[] = [
  {
    ...
    body: (
      <>
        Prioritize <EntityChip name="Bed 5A" /> with follow-up{" "}
        <ValuePill tone="green">before noon</ValuePill>
      </>
    ),
    short: "Prioritize Bed 5A · before noon",
    signal: 3,
    tone: "var(--green)",
    label: "High priority",
    cta: "Accept",
  ...
  },
  {
    ...
    body: (
      <>
        Schedule <ValuePill>discharge planning</ValuePill> for Bed 3B this afternoon.
      </>
    ),
    short: "Discharge planning for Bed 3B",
    signal: 2,
    tone: "var(--orange)",
    label: "Needs review",
    cta: "Configure",
  ...
  },
  {
    ...
    body: (
      <>
        Fall back to a <span className="font-medium text-ink">full review</span> of all pending tasks.
      </>
    ),
    short: "Full review of all pending tasks",
    signal: 0,
    tone: "var(--ink-3)",
    label: "No signal",
    cta: "Accept full review",
    ctaVariant: "primary",
  },
];
